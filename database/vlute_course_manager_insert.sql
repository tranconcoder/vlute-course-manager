...
INSERT INTO `vlute_course_manager`.`authenticate`(username, password) VALUES ("teacheraccount", "passforteacheraccount");
INSERT INTO `vlute_course_manager`.`user`(user_id, account_type, fullname, major_id) VALUES 
(1, "student", "Trần Văn Còn", 1),
(2, "teacher", "Ngọc Nga", 1);
